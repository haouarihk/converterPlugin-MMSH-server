...
class CompilersHandler {
    ...
    compileFile(token, nameprop, compileIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (compiler.CompilerLink) {
                return yield this.requestCompiler(compiler.CompilerLink, `${compiler.commander} "${compilerPath}" ${command}`, (stdout) => {
    ...
    requestCompiler(CompilerLink, cmd, stdcb) {
        return __awaiter(this, void 0, void 0, function* () {
            let data = yield node_fetch_1.default(CompilerLink, {
                method: 'POST',
