...
class CompilersHandler {
    ...
    Command(nameProps, compilerIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const pathToInput = path_1.join(ipath, FileNameWT);
            const pathtoOutput = path_1.join(opath, name);
            const pathToInputWithType = `${path_1.join(ipath, FileNameWT)}`;
            const pathToOutputWithType = `${path_1.join(opath, name, FileNameWT)}`;
    ...
    compileFile({ req, token, nameprops, compileIndex }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (compiler.CompilerLink) {
                return yield this.compileWithLink({ req, token, nameprop: nameprops, compiler, cmd });
            }
