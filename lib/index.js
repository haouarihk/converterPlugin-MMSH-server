...
export default class CompilersHandler {
    ...
    async uploadFile(req, res) {
        ...
        ;
        // check the file size
        if (file.size / 1024 > this.filesizeLimitsMB * 1024) {
        ...
        // defining paths
        var uploadpath = Path.join(this.inputdir, nameWT);
        let downloadpath = Path.join(this.outputdir, newnameWT);
     ...
     */
    Command(FileNameWT, compilerType) {
    ...
    compileFile(FileNameWT, compileType) {
